...
public class QuestionController {
    public static String parse(Map<String, RomanDigit> intergalacticMap, Map<String, Double> ornamentValueMap, String questionStr) {
        ...
        try {
            ...
            answer = questionStr.replace(questionTypeStr, "").replace(QuestionParser.QUESTION_MARK, "") + Parser.IS + BigDecimal.valueOf(answerValue).longValue() + OrnamentQuestionParser.CREDITS;
